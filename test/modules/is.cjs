...
T("isInteger, isNegative, isZero", function () {
	...
	t(!new Decimal(1.23001e2).lessThan(1.23e2));
	t(new Decimal(1.23e2).lt(1.23001e2));
	t(new Decimal(9.999999e2).lessThan(1e3));
	t(!new Decimal(1e3).lt(9.9999999e2));
	...
	t(!new Decimal(1.23001e2).lessThanOrEqualTo(1.23e2));
	t(new Decimal(1.23e2).lte(1.23001e2));
	t(new Decimal(9.999999e2).lessThanOrEqualTo(1e3));
	t(!new Decimal(1e3).lte(9.9999999e2));
	...
	t(new Decimal(1.23001e2).greaterThan(1.23e2));
	t(!new Decimal(1.23e2).gt(1.23001e2));
	t(!new Decimal(9.999999e2).greaterThan(1e3));
	t(new Decimal(1e3).gt(9.9999999e2));
	...
	t(new Decimal(1.23001e2).greaterThanOrEqualTo(1.23e2));
	t(!new Decimal(1.23e2).gte(1.23001e2));
	t(!new Decimal(9.999999e2).greaterThanOrEqualTo(1e3));
	t(new Decimal(1e3).gte(9.9999999e2));
